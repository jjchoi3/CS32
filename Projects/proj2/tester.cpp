...
//  CS32Project2
//
//  Created by Eleanor Pae on 1/25/21.
//  Copyright © 2021 ucla. All rights reserved.
//

// cases that need fixes: 13 (insert), 31-34, 36 (destructor), 35 (empty, size), 45-47 (size), 49-53, 79 (erase), 71 (find), 77 (get, size), 78 (insert/item count), 80-84, 86, 88-91 (remove/insert), 98, 102 (subsequence), 104-112 (interleave)
